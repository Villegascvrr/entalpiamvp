import type { Order, OrderStatus, OrderSummary, RecentOrder } from "./types";
...
export const recentOrders: RecentOrder[] = [
  ...
  { id: "ENT-2024-0138", date: "Ayer", status: "preparing", total: 8920.5 },
  { id: "ENT-2024-0135", date: "12/01", status: "shipped", total: 3400.0 },
];
...
export const adminOrders: Order[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "ENT-ACC-02", name: "Te Cobre 15mm", quantity: 500, price: 3.2 },
      {
        id: "ENT-ACC-03",
        name: "Manguito Cobre 18mm",
        quantity: 400,
        price: 1.85,
      },
    ],
  ...
  // ── Migrated History Orders (to populate "History" view in Demo) ──
  {
    ...
    status: "delivered" as OrderStatus,
    items: [
      { id: "ENT-CU-15", name: "Tubo Cobre 15mm", quantity: 50, price: 245.0 }, // Simplified items
    ],
    total: 12450.0,
    address: "Pol. Ind. Oeste, Nave 12, 41001 Sevilla",
  },
  ...
  },
  {
    ...
    status: "delivered" as OrderStatus,
    items: [
      { id: "ENT-CU-18", name: "Tubo Cobre 18mm", quantity: 40, price: 312.0 },
    ],
    total: 15600.0,
    address: "Pol. Ind. Norte, C/ Principal 45, 28001 Madrid",
  },
  ...
  },
  {
    ...
    status: "delivered" as OrderStatus,
    items: [
      { id: "ENT-CU-22", name: "Tubo Cobre 22mm", quantity: 20, price: 160.0 },
    ],
    total: 3200.0,
    address: "C/ Mayor 99, 45001 Toledo",
  },
