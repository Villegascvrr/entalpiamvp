...
import { Phone, Mail, User, Headset, Send } from "lucide-react";
...
export function AssistedContactDialog({ children }: AssistedContactDialogProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            ...
            toast.success("Solicitud enviada", {
                description: "Un gestor comercial te contactará en menos de 30 minutos.",
                duration: 5000,
            });
        }, 1000);
    };
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        ¿Dudas con tu pedido? Te llamamos ahora mismo para ayudarte a cerrarlo.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="bg-muted/30 p-3 rounded-lg text-xs text-muted-foreground text-center">
                    ...
                    <p className="mt-1 font-medium text-primary">Tiempo medio de respuesta: &lt; 5 min</p>
                </div>
            </DialogContent>
        </Dialog>
    );
