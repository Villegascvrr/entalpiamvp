...
export default function AdminStock() {
  ...
  const [editValues, setEditValues] = useState<{ quantity: number } | null>(
    null,
  );
                  ...
                  {filteredStock.map((entry) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-2 py-1.5 align-middle text-muted-foreground text-[10px]">
                          {entry.lastReceived}
                        </td>
