...
const DEMO_ACCOUNTS = [
  ...
  {
    label: "Comercial",
    email: "comercial@entalpia-demo.com",
    role: "commercial",
    active: false,
  },
  {
    label: "Logística",
    email: "logistica@entalpia-demo.com",
    role: "logistics",
    active: false,
  },
  {
    label: "Cliente",
    email: "cliente@entalpia-demo.com",
    role: "customer",
    active: true,
  },
];
      ...
      <div className="w-full max-w-5xl h-full max-h-[750px] bg-white border border-slate-200 rounded-lg shadow-xl overflow-hidden grid grid-cols-1 lg:grid-cols-12">
        ...
        <div className="lg:col-span-7 p-6 lg:p-10 bg-white flex flex-col justify-center h-full overflow-hidden">
          ...
          <form
            ...
            className="space-y-4 max-w-md w-full flex-shrink-0"
          >
          ...
          <div className="mt-6 pt-4 border-t border-slate-100 flex-shrink-0">
            ...
            <div className="space-y-1.5">
              {[
                ...
                <label
                  key={mode.id}
                  className="flex items-start gap-2.5 cursor-pointer group p-1.5 -mx-1.5 hover:bg-slate-50 rounded-md transition-colors"
                >
