        ...
        <table className="w-full text-sm">
          <thead className="sticky top-0 bg-background z-10">
            <tr className="border-b border-border bg-muted/50">
              <th className="text-left font-medium text-muted-foreground text-[10px] uppercase tracking-wider py-2 px-3">
                Producto
              </th>
          ...
          <div className="h-full flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground/60 mt-1">
                Haz clic en <Plus className="h-3 w-3 inline" /> en el catálogo
                para añadir
              </p>
            </div>
          </div>
              ...
              <div className="flex items-center gap-2 px-4 py-3 rounded-lg bg-green-500/10 text-green-700 border border-green-500/20">
                ...
                <div>
                  ...
                  <p className="text-[11px]">
                    Todo listo para solicitar presupuesto
                  </p>
                </div>
              </div>
            )}
