...
export default function AdminStock() {
  ...
  // ── Computed ──────────────────────────────────────────────────
  const filteredStock = stock.filter((e) => {
    ...
    const disponible = e.quantity - e.stock_reservado;
  ...
  return (
    <AppLayout>
      <div className="flex flex-col h-full bg-background overflow-hidden">
        ...
        {/* ── Main Content ───────────────────────────────────── */}
        <div className="flex-none px-6 py-4 flex flex-col gap-4">
          {/* KPI Cards */}
        ...
        {/* ── Filters ────────────────────────────────────────── */}
        <div className="flex-none px-6 py-3 border-b border-border/60 bg-white">
        ...
        <div className="flex-1 p-6 bg-slate-50/50 overflow-hidden flex flex-col">
          <div className="flex-1 rounded-xl border bg-card shadow-sm flex flex-col overflow-hidden min-h-[400px]">
            <div className="flex-1 overflow-y-auto scrollbar-thin">
              <table className="w-full text-sm">
                <thead className="bg-muted/40 sticky top-0 z-10">
                  <tr className="border-b border-border/60 text-[10px] text-muted-foreground uppercase tracking-wider">
                    <th className="text-left px-6 py-3 font-medium w-[30%]">
                      {t("adminStock.columns.product")}
                    </th>
                    <th className="text-left px-4 py-3 font-medium w-[15%]">
                    ...
                    <th className="text-right px-6 py-3 font-medium w-[9%]">
                  ...
                  {filteredStock.map((entry) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Stock reservado */}
                        <td className="px-4 py-3 align-middle text-right text-sm text-foreground">
                        ...
                        <td className="px-4 py-3 align-middle text-center">
                          <Badge
                            variant="outline"
                            className={cn(
                              "h-5 px-2 text-[10px] rounded-sm uppercase tracking-wider justify-center min-w-[72px]",
                              cfg.badgeClass,
                            )}
                          >
                            {cfg.label}
                        ...
                        <td className="px-6 py-3 align-middle text-right">
                          {editingId === entry.id ? (
                            ...
                            <div className="flex justify-end gap-1">
                              ...
                              <div className="w-px h-3 bg-border/50 my-auto mx-1" />
                              <Button
                                variant="ghost"
                                size="icon"
